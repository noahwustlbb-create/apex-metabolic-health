        ...
        >
          ...
          >
            ...
            <p className="text-sm leading-relaxed mb-8" style={{ color: '#888888' }}>
              ...
              site you confirm that you are <strong style={{ color: '#F5F5F5' }}>18 years of age or older</strong> and
            ...
            <p className="text-xs mt-6 leading-relaxed" style={{ color: '#888888' }}>
