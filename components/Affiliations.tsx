...
const BADGES = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="#3575C6" strokeWidth="1.5" aria-hidden="true">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {BADGES.map((badge, i) => (
            <motion.div
              ...
              style={{
                background: 'rgba(53,117,198,0.03)',
                border: '1px solid rgba(53,117,198,0.1)',
              }}
            >
              <div
                ...
                style={{
                  ...
                  border: '1px solid rgba(53,117,198,0.15)',
                }}
              >
                {badge.icon}
              </div>
              <div>
                ...
                <p className="text-[10px]" style={{ color: '#0a0e1a' }}>
                  {badge.sublabel}
                </p>
              </div>
            </motion.div>
