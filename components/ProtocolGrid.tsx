...
export const PROTOCOLS: Protocol[] = [
  ...
  { id: 'skin',        col: 3, code: 'APX-06', label: 'Skin Regeneration',          sub: 'Cortisol · DHEA-S · Inflammation',   href: '/programs/skin-regeneration',     image: 'https://images.unsplash.com/photo-1781178339148-d6ac1edb7b8f?auto=format&fit=crop&w=1200&q=85' /* TODO swap for /protocols/skin.jpg once generated */,        swatch: '#d4a5a5' },
  { id: 'hair',        col: 3, code: 'APX-07', label: 'Hair Restoration',           sub: 'DHT · SHBG · Ferritin · Thyroid',    href: '/programs/hair-restoration',      image: '/img-hair-restoration.png' /* TODO swap for /protocols/hair.jpg once generated */,        swatch: '#0f766e' },
  { id: 'performance', col: 1, code: 'APX-08', label: 'Performance Plus',           sub: 'Output · Recovery · Composition',    href: '/programs/performance-plus',      image: '/protocols/performance.jpg' /* TODO temporary: hormone variant 2 until the performance texture is generated */, swatch: '#e2e8f0' },
  { id: 'bloods',      col: 2, code: 'APX-09', label: 'Comprehensive Blood Tests',  sub: 'Full panel · Doctor reviewed',       href: '/programs/pathology',             image: 'https://images.unsplash.com/photo-1570917013020-a6966d3ee863?auto=format&fit=crop&w=1200&q=85' /* TODO swap for /protocols/bloods.jpg once generated */,      swatch: '#b91c1c' },
]
