    ...
    <div className="min-h-screen flex flex-col" style={{ background: BG }}>
      ...
      <div className="flex items-center justify-between px-6 sm:px-10 py-5 flex-shrink-0" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full" style={{ background: 'rgba(72,144,247,0.08)', border: '1px solid rgba(72,144,247,0.15)' }}>
            ...
            <span className="text-[10px] font-semibold" style={{ color: '#4b5563' }}>Secure checkout</span>
          </div>
          <button
            onClick={() => router.back()}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="hidden lg:flex flex-col w-80 flex-shrink-0 px-8 py-8 overflow-y-auto" style={{ borderRight: '1px solid rgba(0,0,0,0.04)' }}>
          ...
          <p className="text-xs mb-6 leading-relaxed" style={{ color: '#6b7280' }}>{subtitle}</p>

          <div className="h-px mb-6" style={{ background: 'rgba(0,0,0,0.05)' }} />

          <p className="text-[10px] font-semibold tracking-[0.15em] uppercase mb-3" style={{ color: '#6b7280' }}>Biomarkers included</p>
          ...
          {!loaded && (
            <div className="absolute inset-0 flex items-center justify-center" style={{ background: BG }}>
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-xs" style={{ color: '#6b7280' }}>Loading secure checkout…</p>
              </div>
            </div>
          )}
          <iframe
      ...
      <div className="px-6 py-3 text-center flex-shrink-0" style={{ borderTop: '1px solid rgba(0,0,0,0.03)' }}>
        <p className="text-[9px] tracking-widest uppercase" style={{ color: '#d1d5db' }}>
