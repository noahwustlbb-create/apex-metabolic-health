...
const CARDS = [
  ...
  { label: 'Membership', prefix: '', value: '$99', suffix: '/ month', single: 'Optional', note: 'No lock-in. Medication at cost price, no escript fees, follow-up bloods $139, every panel in your trend.', highlight: true },
]
