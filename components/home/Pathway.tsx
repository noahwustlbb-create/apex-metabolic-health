...
export const STEPS = [
  ...
  { when: 'Week 2',   readout: 'Wk 02',  title: 'Protocol at your door', body: 'Anything prescribed is filled by a TGA-compliant Australian pharmacy and delivered discreetly, with instructions in your portal.', src: '/photos/protocol-box.webp', alt: 'A discreet Apex delivery on a kitchen bench' },
