  ...
  return (
    <section id="hero" className="relative overflow-hidden" style={{ background: 'var(--bg)' }} aria-label="Introduction">
      ...
      <div className="container-x relative" style={{ paddingTop: 'clamp(104px, 13vh, 150px)', paddingBottom: 'clamp(48px, 7vh, 96px)' }}>
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.92fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{ width: '100%', maxWidth: 560, aspectRatio: '3 / 4', minHeight: 360 }}
            >
            ...
            <p className="t-mono text-center mt-3" style={{ color: 'var(--text-muted)', fontSize: 9.5 }}>
