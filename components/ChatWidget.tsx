          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[13px] font-semibold" style={{ color: '#F5F5F5', fontFamily: 'var(--font-space-grotesk)' }}>
                    Apex Clinical Advisor
                  </p>
                  <div className="flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />
                    <span className="text-[10px]" style={{ color: '#888888' }}>Online now</span>
                  </div>
                </div>
              </div>
              <button
              ...
              {!started && (
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: '#161616', color: '#F5F5F5' }}
                  >
                  ...
                  <div
                    ...
                    style={
                      msg.role === 'user'
                        ...
                        : { backgroundColor: '#161616', color: '#F5F5F5', borderRadius: '12px 12px 12px 2px' }
                    }
                  >
              ...
              {loading && messages[messages.length - 1]?.role !== 'assistant' && (
                <div className="flex justify-start">
                  <div
                    ...
                    style={{ backgroundColor: '#161616', borderRadius: '12px 12px 12px 2px' }}
                  >
                    <TypingIndicator />
                  </div>
                </div>
