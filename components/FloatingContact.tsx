    ...
    >
                  ...
                  <div key={step.number}>
                    ...
                    >
                      <span
                        ...
                        style={{
                          backgroundColor: isOpen ? 'rgba(72,144,247,0.15)' : 'rgba(255,255,255,0.04)',
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = '0 8px 32px rgba(0,0,0,0.5), 0 0 20px rgba(72,144,247,0.1)'
        }}
        onMouseLeave={(e) => {
