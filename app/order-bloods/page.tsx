    ...
    >
      ...
      <div className="flex items-start gap-4 mb-6">
        <div
          ...
          style={{ backgroundColor: 'rgba(72,144,247,0.07)', border: '1px solid rgba(72,144,247,0.18)' }}
        >
          {icon}
        </div>
      ...
      <main>
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse at 0% 0%, rgba(72,144,247,0.06) 0%, transparent 60%)',
            }}
          />
