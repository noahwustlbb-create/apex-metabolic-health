      ...
      <main style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', paddingTop: '120px', paddingBottom: '80px' }}>
        <div className="container-tight max-w-3xl">
          ...
          <div className="space-y-8 text-base leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>1. About This Policy</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>4. Disclosure of Your Information</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>5. Storage and Security</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>6. Your Rights</h2>
              ...
              <p className="mt-3">To exercise any of these rights, contact us at <strong style={{ color: 'var(--text-primary)' }}>admin@apexmetabolichealth.com.au</strong>. We will respond within 30 days.</p>
            </section>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>8. Complaints</h2>
              <p>If you believe we have breached your privacy, please contact us in the first instance at <strong style={{ color: 'var(--text-primary)' }}>admin@apexmetabolichealth.com.au</strong>. If you are not satisfied with our response, you may lodge a complaint with the Office of the Australian Information Commissioner (OAIC) at <strong style={{ color: 'var(--text-primary)' }}>oaic.gov.au</strong>.</p>
            </section>

            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>9. Updates to This Policy</h2>
