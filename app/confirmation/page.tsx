...
export default function ConfirmationPage() {
    ...
    fetch(`/api/verify-session?session_id=${sessionId}`)
      ...
      .then(data => {
        if (data.ok) {
          ...
          // Clear intake data from session storage
  ...
  if (verified === null) {
    return (
      <>
        <Nav />
        <main style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', paddingTop: '120px' }}>
        ...
        <main style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', paddingTop: '120px', paddingBottom: '80px' }}>
          <div className="container-tight max-w-md mx-auto text-center">
            <p className="text-sm mb-4" style={{ color: 'var(--text-primary)', opacity: 0.6 }}>
              We couldn&apos;t verify your payment. If you completed a payment, check your email for a confirmation receipt. Contact us if you need help.
            </p>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, rgba(72,144,247,0.12), rgba(255,255,255,0.03) 60%, transparent)',
                marginBottom: 28,
              }}
            />
            ...
            >
              {(isPanel ? [
                ...
                { step: 'Doctor review', detail: 'Your doctor reviews your health history and blood results before the consultation — no time wasted on basics.' },
                ...
                <div key={i} className="flex gap-4 items-start">
                  <div style={{
                    ...
                    background: 'rgba(72,144,247,0.06)', border: '1px solid rgba(72,144,247,0.15)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: 9, fontWeight: 700, color: '#4890f7', fontFamily: 'var(--font-space-grotesk)',
                  }}>{i + 1}</div>
                  <div>
