    ...
    <>
      ...
      <main style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', paddingBottom: '100px' }}>
        ...
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none overflow-hidden">
          <Image src="/protocols/hero.jpg" alt="" fill className="object-cover object-center" style={{ opacity: 0.18 }} unoptimized />
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs leading-relaxed" style={{ color: 'var(--text-primary)', opacity: 0.72 }}>{p.sub}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
