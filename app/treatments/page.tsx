...
const TREATMENTS = [
  { href: '/programs/hormone-optimisation', label: 'Hormone Optimisation', sub: 'Energy, drive and recovery, restored through precise hormonal balancing.', image: '/shoot/hormone.jpg', imgPos: 'center 30%', tag: 'Most popular' },
  { href: '/programs/metabolic-weight-loss', label: 'Medical Weight Loss', sub: 'A doctor-led metabolic reset that targets the real drivers of weight resistance.', image: '/shoot/weight.jpg', imgPos: 'center center', tag: null },
  { href: '/programs/sexual-health', label: 'Sexual Health', sub: 'Private, confidential care that treats the root cause, not just the symptom.', image: '/shoot/sexual.jpg', imgPos: 'center center', tag: null },
  { href: '/programs/injury-repair', label: 'Recovery and Injury Repair', sub: 'Regenerative protocols for performance, rehabilitation and mobility.', image: '/shoot/recovery.jpg', imgPos: 'center center', tag: null },
  { href: '/programs/longevity', label: 'Anti-Ageing and Longevity', sub: 'Healthspan, vitality and prevention, measured and managed over time.', image: '/shoot/longevity.jpg', imgPos: 'center center', tag: 'New' },
  { href: '/programs/skin-regeneration', label: 'Skin and Hair', sub: 'Evidence-based restoration and regeneration for skin and hair.', image: '/shoot/skin.jpg', imgPos: 'center center', tag: null },
  { href: '/programs/pathology', label: 'Comprehensive Blood Tests', sub: 'Full-panel diagnostics that go well beyond the standard GP screen, doctor reviewed.', image: '/shoot/consult.jpg', imgPos: 'center center', tag: null },
]
