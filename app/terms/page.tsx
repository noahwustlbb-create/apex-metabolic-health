      ...
      <main style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', paddingTop: '120px', paddingBottom: '80px' }}>
        <div className="container-tight max-w-3xl">
          ...
          <div className="space-y-8 text-base leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>1. About These Terms</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>3. Eligibility</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>5. Clinical Suitability</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>6. Therapeutic Goods</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>8. Cancellations and Refunds</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>9. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>10. Governing Law</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-space-grotesk)' }}>11. Contact</h2>
              <p>For any questions regarding these terms, contact us at <strong style={{ color: 'var(--text-primary)' }}>admin@apexmetabolichealth.com.au</strong>.</p>
            </section>
