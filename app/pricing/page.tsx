        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            >
              ...
              <span style={{ color: 'rgba(10,14,26,0.2)' }}>Your choice.</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 16 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3">
            {OPTIONS.map((opt, i) => (
              <motion.div
                ...
                style={{
                  background: '#ffffff',
                  border: opt.featured ? '1px solid rgba(72,144,247,0.25)' : '1px solid rgba(72,144,247,0.1)',
                  boxShadow: opt.featured ? '0 8px 32px rgba(72,144,247,0.08)' : '0 2px 8px rgba(0,0,0,0.04)',
                }}
              >
                {opt.tag && (
