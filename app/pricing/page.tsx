    ...
    >
      ...
      <div className="flex flex-col items-center flex-shrink-0" style={{ width: '56px' }}>
        ...
        <div
          ...
          style={{ backgroundColor: 'rgba(0,194,184,0.12)', minHeight: '32px' }}
          aria-hidden="true"
        />
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 100% 0%, rgba(0,194,184,0.08) 0%, transparent 60%)',
        }}
      />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 0% 100%, rgba(0,194,184,0.06) 0%, transparent 60%)',
        }}
      />
