...
const config: QuizConfig = {
  ...
  steps: [
    ...
    {
      type: 'single', id: 'mood',
      question: 'Do you experience mood changes — irritability, low motivation, or mental fog?',
      options: [
    ...
    },
    {
      ...
      question: 'Do you struggle with sleep quality — waking tired or difficulty staying asleep?',
      options: [
    ...
    },
    {
      ...
      body: 'The symptoms above align with validated clinical screening criteria for hormonal imbalance. They are assessed alongside pathology results by our AHPRA-registered doctors — not used to diagnose you, but to identify men who would benefit most from a full clinical assessment.',
