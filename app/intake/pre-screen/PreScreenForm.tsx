...
function getClinicalObservations(data: FormData, pathway: Pathway): string[] {
  ...
  if (data.history === 'gp_normal') {
    obs.push('Prior GP testing returned "normal", but standard panels miss free testosterone, LH/FSH, oestradiol, and cortisol, which are the markers that actually explain your symptoms.')
