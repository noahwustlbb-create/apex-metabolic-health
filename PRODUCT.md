...
Clinical. Unhurried. Direct.

The emotional register is quiet authority — the confidence of a specialist who doesn't need to convince you. Not urgent, not glossy, not performative. The site should feel like it's been designed for the patient, not to sell to them.

## Anti-references

- **Biov8** — over-designed, supplement-brand energy, loud CTAs
- **Everlab** — corporate and safe, doesn't feel clinical
- **Optimal Health Clinic** — generic, cluttered, outdated
- **Generic Framer/shadcn wellness templates** — the default AI-designed healthcare look
- **The current Apex site** — the exact section order (hero → trust badges → stat bar → cards → grid → numbered steps → doctor card → testimonials → FAQ) is the pattern to move away from
...
WCAG AA minimum — this is a healthcare site. Every animation requires a `prefers-reduced-motion` fallback. No visual element may imply a clinical outcome or result.
